...
export default {
	router: {
		home: '首页',
		dataSource: '数据源管理',
		collectionConfig: '采集配置管理子系统',
		datatopic: '数据主题',
		datatype: '数据类型',
		collectionTask: '采集任务',
		collectionTaskDetail: '采集任务详情',
		collectionTaskConfig: '采集任务配置',
		collectionExecute: '采集执行控制子系统',
		collectionTaskCreate: '采集任务创建',
		collectionTaskScheduler: '采集任务调度',
		collectionMonitor: '采集监控追溯子系统',
		collectionTaskMonitor: '采集任务监控',
		appConfig: '应用配置子系统',
		appScene: '应用场景配置',
		watchTarget: '关注标的配置',
		appMetric: '应用指标配置',
